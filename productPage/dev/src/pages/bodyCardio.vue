<template>
  <div class="warp">
    ...
    <img v-for='(data,index) in lazyimgArr' v-lazy='lazyimgArr[index]' :key='index'>
...
import img11 from '../assets/img/bodyCardio/bg_11.jpg'
import img12 from '../assets/img/bodyCardio/bg_12.jpg'
...
export default {
  ...
  data() {
    return {
      ...
      imgArr: [img1, img2],
      lazyimgArr: [img3, img4, img5, img6, img7, img8, img9, img10, img11, img12]
    }
  },
  components: {
    down,
  ...
  methods: {
    ...
    goBuy() {
      ...
      if (this.$common.common.$_GET('shareType') == 1) {
        window.location.href = 'https://app.hxsapp.com/hxsweb/shopDetail/BodyCardio'
        return false
      }
      ...
      window.location.href = 'https://app.hxsapp.com/hxsweb/shopDetail/BodyCardio' + '?sess_token=' + this.json.sess_token + '&'
      // window.location.href = 'https://hxsapp_new_webview#' + 'https://app.hxsapp.com/hxsweb/shopDetail/BodyCardio'
    },
  }
}
</script>
